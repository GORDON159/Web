...
$t = 1;
$t1 = 1;
$handle = popen(".\information6.py","r");
sleep(10);
$file_href = file("./href6.txt");
$lines = file("./text6.txt");
...
<!DOCTYPE html>
<html lang="en">
    <title>Candice Sweat Life</title>
    <meta charset="utf-8" />
...
<section class="resume-section" id="1">
            ...
            <hr class="m-0" />
                ...
                <div class="resume-section-content">
                    <h2 class="mb-5">切換</h2>
                    <div>
                    <input type="button" value="依照熱門度" onclick="location.href='ytb6_2.php'">
